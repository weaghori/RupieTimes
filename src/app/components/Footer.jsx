...
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaTwitter, FaMapMarkerAlt, FaPhone, FaEnvelope, FaShieldAlt, FaFileContract, FaCookie } from 'react-icons/fa';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-white/20 pb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
              Empowering decisions with reliable insights.  
              Get in touch with our analysts for personalized support.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
              ...
              <li>
                <a href="/about" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
                  <span className="w-1.5 h-1.5 bg-[#c19755] rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  About Us
                </a>
              </li>
              <li>
                <a href="/services" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
                  <span className="w-1.5 h-1.5 bg-[#c19755] rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  Services
                </a>
              </li>
              <li>
                <a href="/rupieTimes/contactUs" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
                  <span className="w-1.5 h-1.5 bg-[#c19755] rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  Contact
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/faq" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
                  <span className="w-1.5 h-1.5 bg-[#c19755] rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  FAQs
                </a>
              </li>
              <li>
                <a href="/privacy-policy" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
                  <span className="w-1.5 h-1.5 bg-[#c19755] rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="/terms" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
                  <span className="w-1.5 h-1.5 bg-[#c19755] rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  Terms & Conditions
                </a>
              </li>
              <li>
                <a href="/support" className="hover:text-[#c19755] transition-all duration-300 flex items-center group">
                  <span className="w-1.5 h-1.5 bg-[#c19755] rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  Help Center
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li>
                <a href="tel:+18005551234" className="flex items-center space-x-3 group hover:text-white transition-colors duration-300">
                  <div className="w-8 h-8 bg-[#c19755]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1 group-hover:bg-[#c19755] transition-all duration-300">
              ...
              <li>
                <a href="mailto:info@company.com" className="flex items-center space-x-3 group hover:text-white transition-colors duration-300">
                  <div className="w-8 h-8 bg-[#c19755]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1 group-hover:bg-[#c19755] transition-all duration-300">
